...
import SDG12b from "../assets/E_GIF_12.gif";
import SDG13 from "../assets/E_WEB_13.png";
import SDG13b from "../assets/E_GIF_13.gif";
import SDG14 from "../assets/E_WEB_14.png";
import SDG14b from "../assets/E_GIF_14.gif";
...
export const sdgs = [
    {
        ...
        description: `Nonostante i notevoli progressi nella lotta contro la povertà a partire dal 1990, più di 800 milioni di
                ...
                per lo sviluppo sostenibile si pone l'obiettivo di eliminare la povertà estrema entro il 2030. Oltre
                l'obiettivo di sradicare la povertà estrema, l’Obiettivo 1 riguarda un approccio globale alla povertà
                nel suo complesso, ma pone anche un bersaglio sulle singole realtà nazionali di povertà. I poveri sono
                particolarmente vulnerabili alle crisi economiche e politiche, alle problematiche di biodiversità e
    ...
    },
    {
        ...
        sdgGif: SDG3b,
        isUsed: true,
        description: `Gli Obiettivi di sviluppo del millennio (MDG) hanno dato un contributo significativo al
    ...
    },
    {
        ...
        sdgGif: SDG4b,
        isUsed: true,
        description: `La comunità internazionale ha ribadito l'importanza della formazione e istruzione di buona qualità
    ...
    },
    {
        ...
        sdgGif: SDG8b,
        isUsed: true,
        description: ` Secondo i dati attuali, oltre 200 milioni di persone in tutto il mondo sono disoccupati, soprattutto
    ...
    },
    {
        ...
        sdgGif: SDG11b,
        isUsed: true,
        description: ` L’urbanizzazione globale è uno degli sviluppi più significativi del 21 ° secolo. Più della metà
    ...
    },
    {
        ...
        sdgGif: SDG12b,
        isUsed: true,
        description: ` La popolazione mondiale attualmente consuma più risorse rispetto a quelle che gli ecosistemi siano
    ...
    },
    {
        ...
        sdgGif: SDG13b,
        isUsed: true,
        description: `Il cambiamento climatico è una sfida chiave in materia di sviluppo sostenibile. Il riscaldamento del
    ...
    },
    {
        ...
        sdgGif: SDG14b,
        isUsed: true,
        description: ` Inquinamento e sfruttamento eccessivo dei nostri oceani sono la causa di sempre maggiori problemi,
    ...
    },
    {
        ...
        sdgGif: SDG15b,
        isUsed: true,
        description: `  La conservazione e l'uso sostenibile della biodiversità sono di vitale importanza per lo sviluppo
