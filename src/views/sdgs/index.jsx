...
const Sdgs = () => {
    ...
    return (
        <PageContainer>
            ...
            <Sdg onClick={() => renderDescription(3)} onKeyPress={() => renderDescription(3)}>
            ...
            <Sdg onClick={() => renderDescription(4)} onKeyPress={() => renderDescription(4)}>
            ...
            <Sdg onClick={() => renderDescription(8)} onKeyPress={() => renderDescription(8)}>
            ...
            <Sdg onClick={() => renderDescription(11)} onKeyPress={() => renderDescription(11)}>
            ...
            <Sdg onClick={() => renderDescription(13)} onKeyPress={() => renderDescription(13)}>
            ...
            <Sdg onClick={() => renderDescription(14)} onKeyPress={() => renderDescription(14)}>
            ...
            <Sdg onClick={() => renderDescription(15)} onKeyPress={() => renderDescription(15)}>
