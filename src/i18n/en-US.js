export default {
    ...
    "c-splugaCard.description": "thanks for your help, {n} trees have been saved!",
    ...
    "c-splugaNewTarget.summary.name": "name",
    "c-splugaNewTarget.summary.description": "description",
    "c-splugaNewTarget.summary.goal": "goal",
    "c-splugaNewTarget.summary.target": "limit/target",
    "c-splugaNewTarget.summary.startDate": "start date",
    "c-splugaNewTarget.summary.endDate": "end date",
    "c-splugaNewTarget.type": "Typology",
    "c-splugaNewTarget.type.limit": "Limit",
    "c-splugaNewTarget.type.value": "Value",

    "c-splugsTarget.cardTitle": "Your Target's trend",

    //Views
    "v-apps.message":
        "Make sure to copy key value below somewhere safe, otherwise you will need to generate a new key.",
    "v-apps.create": "New app {appName} created",
    "v-apps.create.title": "Create a new app",
    "v-apps.name": "App name",
