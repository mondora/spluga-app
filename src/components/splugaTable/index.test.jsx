...
describe("SplugaTable", () => {
    ...
    it("Render component without data", () => {
        const element = shallow(<SplugaTable datasource={null} loadingStatus={true} onChange={onChange} />);
    ...
    it("Render component with data", () => {
        ...
        const element = shallow(<SplugaTable dataSource={data} onChange={onChange} />);
